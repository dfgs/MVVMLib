...
namespace ViewModelLib.Attributes
{
	...
	public class LargeTimeSpanPropertyAttribute:PropertyAttribute
	{
		...
		{
			return new LargeTimeSpanViewModelProperty(ViewModels,pd, Header ?? pd.Name, Category, IsMandatory, IsReadOnly,AutoApply);
		}

...
namespace ViewModelLib.Attributes
{
	...
	public class TextListPropertyAttribute:ListPropertyAttribute
	{
		...
		{
			return new TextListViewModelProperty(ViewModels, pd, Header ?? pd.Name, Category, IsMandatory, IsReadOnly,AutoApply, SourcePath, SelectedValuePath, DisplayMemberPath);
		}

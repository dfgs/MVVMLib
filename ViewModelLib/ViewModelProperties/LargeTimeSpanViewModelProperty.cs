...
namespace ViewModelLib.ViewModelProperties
{
	public class LargeTimeSpanViewModelProperty: ViewModelProperty<TimeSpan?>
	{
		...
		public LargeTimeSpanViewModelProperty(IEnumerable<IViewModel> ViewModels, PropertyDescriptor pd, string Header,bool IsMandatory, bool IsReadOnly, bool AutoApply)

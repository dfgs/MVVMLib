...
namespace ViewModelLib.ViewModelProperties
{
	public class DateTimeViewModelProperty: ViewModelProperty<DateTime?>
	{
		...
		public DateTimeViewModelProperty(IEnumerable<IViewModel> ViewModels, PropertyDescriptor pd, string Header,bool IsMandatory, bool IsReadOnly, bool AutoApply)

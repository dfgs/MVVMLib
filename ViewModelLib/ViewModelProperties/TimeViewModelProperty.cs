...
namespace ViewModelLib.ViewModelProperties
{
	public class TimeViewModelProperty: ViewModelProperty<DateTime?>
	{
		...
		public TimeViewModelProperty(IEnumerable<IViewModel> ViewModels, PropertyDescriptor pd, string Header, string Category, bool IsMandatory, bool IsReadOnly, bool AutoApply)
